...
QT_MOC_LITERAL(7, 53, 16) // "structureUpdated"
    ...
    "dbChanged\0dirty\0structureUpdated"
};
...
void DBBrowserDB::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DBBrowserDB::sqlExecuted)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DBBrowserDB::dbChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DBBrowserDB::structureUpdated)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject DBBrowserDB::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DBBrowserDB.data,
      qt_meta_data_DBBrowserDB,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DBBrowserDB::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DBBrowserDB.stringdata0))
        return static_cast<void*>(const_cast< DBBrowserDB*>(this));
...
// SIGNAL 0
void DBBrowserDB::sqlExecuted(QString _t1, int _t2)
{
