...
QT_MOC_LITERAL(1, 15, 10), // "gotDirList"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "json"
QT_MOC_LITERAL(4, 32, 8), // "userdata"
QT_MOC_LITERAL(5, 41, 8), // "openFile"
QT_MOC_LITERAL(6, 50, 4), // "path"
QT_MOC_LITERAL(7, 55, 17), // "gotCurrentVersion"
QT_MOC_LITERAL(8, 73, 7), // "version"
QT_MOC_LITERAL(9, 81, 3) // "url"

    },
    "RemoteDatabase\0gotDirList\0\0json\0"
    "userdata\0openFile\0path\0gotCurrentVersion\0"
    "version\0url"
};
...
void RemoteDatabase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gotDirList((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QVariant(*)>(_a[2]))); break;
        case 1: _t->openFile((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->gotCurrentVersion((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RemoteDatabase::gotDirList)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RemoteDatabase::openFile)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RemoteDatabase::gotCurrentVersion)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject RemoteDatabase::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RemoteDatabase.data,
      qt_meta_data_RemoteDatabase,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RemoteDatabase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RemoteDatabase.stringdata0))
        return static_cast<void*>(const_cast< RemoteDatabase*>(this));
