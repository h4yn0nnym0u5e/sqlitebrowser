...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        label_imagelogo->setObjectName(QStringLiteral("label_imagelogo"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About DB Browser for SQLite", Q_NULLPTR));
